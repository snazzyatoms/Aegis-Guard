...
public class ProtectionManager implements Listener {
    ...
    public void onInteract(PlayerInteractEvent e) {
        ...
        if (!canBuild(p, plot) && isContainer(block.getType())) {
            if (plugin.worldRules().allowContainers(block.getWorld()) &&
    ...
    public void onPvP(EntityDamageByEntityEvent e) {
        ...
        if (!plugin.worldRules().isPvPAllowed(victim.getWorld()) &&
    ...
    public void onPetDamage(EntityDamageByEntityEvent e) {
        ...
        if (!plugin.worldRules().allowPets(pet.getWorld()) &&
    ...
    public void onEntityInteract(PlayerInteractEntityEvent e) {
        ...
        if (!plugin.worldRules().allowContainers(stand.getWorld()) &&
    ...
    public void onTarget(EntityTargetEvent e) {
        ...
        if (!plugin.worldRules().allowMobs(p.getWorld()) &&
    ...
    public void onSpawn(EntitySpawnEvent e) {
        ...
        if (!plugin.worldRules().allowMobs(e.getLocation().getWorld()) &&
    ...
    public void onFarmTrample(PlayerInteractEvent e) {
        ...
        if (!plugin.worldRules().allowFarms(p.getWorld()) &&
    ...
    public boolean isPvPEnabled(Player player) {
        return hasFlag(player, "pvp") && !plugin.worldRules().isPvPAllowed(player.getWorld());
    }

    public void togglePvP(Player player) { toggleFlag(player, "pvp"); }

    public boolean isContainersEnabled(Player player) {
        return hasFlag(player, "containers") && plugin.worldRules().allowContainers(player.getWorld());
    }
    ...
    public boolean isMobProtectionEnabled(Player player) {
        return hasFlag(player, "mobs") && !plugin.worldRules().allowMobs(player.getWorld());
    }

    public void toggleMobProtection(Player player) { toggleFlag(player, "mobs"); }

    public boolean isPetProtectionEnabled(Player player) {
        return hasFlag(player, "pets") && plugin.worldRules().allowPets(player.getWorld());
    }
    ...
    public boolean isEntityProtectionEnabled(Player player) {
        return hasFlag(player, "entities") && plugin.worldRules().allowContainers(player.getWorld());
    }
    ...
    public boolean isFarmProtectionEnabled(Player player) {
        return hasFlag(player, "farm") && plugin.worldRules().allowFarms(player.getWorld());
    }
